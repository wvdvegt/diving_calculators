...
function getlabels() {
	...
	if (stop_safety != 0) {
		...
		result += '|ASafety stop: '+stop_safety+'min. at 5m,,0,10,'+afont;
		result += '|H,FF000040,0,10,1,1';
	}
	
	if (stop_03 != 0) {
		//result += '|s,FF0000,0,12:12,5';
		result += '|AStop '+stop_03+'min. at 3m,,0,12,'+afont;
...
function calcDP() {
	...
	if(isNaN(duikdiepte ) || isNaN(duiktijd ) || duikdiepte *1<1 || duikdiepte *1>90 || duiktijd *1<0) {
		$("#oSaturatie").html('n/a');
		$("#oStijgTijd").html('n/a');
